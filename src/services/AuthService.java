    ...
    public Evaluator loginEvaluator(String username, String password) {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                // Note: User table doesn't have email, but Evaluator model expects it. passing
                // username as placeholder or null
                return new Evaluator(id, name, "no-email", password);
            }
