...
public class SubmissionDAO {
    ...
    public void createSubmission(String seminarId, String studentId, String title, String abstractText, String supervisor, String presentationType) throws SQLException {
    ...
    private void autoAssignToSession(String seminarId, String studentId, String presentationType) {
        ...
        try (Connection conn = DatabaseConnection.getConnection(); PreparedStatement findStmt = conn.prepareStatement(findSessionSql)) {
    ...
    public List<Submission> getAllSubmissionsList() {
        ...
        try (Connection conn = DatabaseConnection.getConnection(); Statement stmt = conn.createStatement(); ResultSet rs = stmt.executeQuery(sql)) {
            while (rs.next()) {
                ...
                Submission sub = new Submission(submissionId, seminarId, studentId, title, abstractText, supervisor, presentationType);
